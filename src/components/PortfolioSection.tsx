...
const MissionStatement = ({ activeRole = "captain" }: { activeRole?: "captain" | "editor" }) => {
  ...
  const certifications: Certification[] = [
    ...
    },
    {
      ...
      issuer: "Google",
      logo: "/certs/gemini-educator.png",
      color: "#4285F4",
      description: "Proficiency in leveraging Google's Gemini AI for educational purposes and innovation.",
      date: "2024"
    },
    {
      id: "oci-ai",
      ...
      >
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 mt-2 max-w-2xl mx-auto">
              Professional certifications spanning cloud computing, AI, and data literacy
            </p>
          </div>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-slate-400 mt-2 max-w-2xl mx-auto">
              A curated collection of technical projects and editorial work
            </p>
          </div>
